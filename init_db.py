...
cursor.execute('create table ProductsInventory(ITEM_NUMBER integer primary key autoincrement, NAME varchar(100), COLOR varchar(20), PRICE varchar(20), QUANTITY int)')
cursor.execute('insert into ProductsInventory (ITEM_NUMBER, %s) values (16753495, \'2021 Yamaha Star Venture\', \'white\', \'$26,999\', 4)' % schema)
cursor.execute('insert into ProductsInventory (%s) values (\'2021 Harley Davidson Low Rider S\', \'black\', \'$17,999\', 4)' % schema)
cursor.execute('insert into ProductsInventory (%s) values (\'2020 Yamaha Tracer 900 GT\', \'black\', \'$12,999\', 3)' % schema)
cursor.execute('insert into ProductsInventory (%s) values (\'2019 Honda Gold Wing Tour\', \'red\', \'$28,300\', 2)' % schema)
cursor.execute('insert into ProductsInventory (%s) values (\'2021 Yamaha FJR1300ES\', \'blue\', \'$17,999\', 6)' % schema)
cursor.execute('insert into ProductsInventory (%s) values (\'2021 Harley Davidson Livewire\', \'black\', \'$29,799\', 6)' % schema)
cursor.execute('insert into ProductsInventory (%s) values (\'2019 Honda Rebel 500\', \'black\', \'$4,599\', 3)' % schema)
cursor.execute('insert into ProductsInventory (%s) values (\'2020 Harley Davidson Forty-Eight\', \'black\', \'$11,299\', 3)' % schema)
cursor.execute('insert into ProductsInventory (%s) values (\'2018 Honda CRF300L Rally\', \'red\', \'$5,999\', 2)' % schema)
cursor.execute('insert into ProductsInventory (%s) values (\'2020 Harley Davidson Softail Slim\', \'red\', \'$15,999\', 4)' % schema)
cursor.execute('insert into ProductsInventory (%s) values (\'2018 Yamaha Star Eluder\', \'silver\', \'$22,499\', 2)' % schema)
cursor.execute('select * from ProductsInventory')
print(cursor.fetchall())

schema = 'NAME, PRICE, QUANTITY'
cursor.execute('drop table PartsInventory')
cursor.execute('create table PartsInventory(ITEM_NUMBER integer primary key autoincrement, NAME varchar(100), PRICE varchar(20), QUANTITY int)')
...
cursor.execute('insert into PartsInventory (%s) values (\'Twin Power high Performance AGM Battery\', \'$202.95\', 3)' % schema)
...
cursor.execute('create table MerchandiseInventory(ITEM_NUMBER integer primary key autoincrement, NAME varchar(100), COLOR varchar(20), SIZE varchar(10), PRICE varchar(20), QUANTITY int)')
...
cursor.execute('insert into MerchandiseInventory (%s) values (\'Yamaha Paddock Pulse Pit Shirt\', \'blue\', \'XL\', \'$79.99\', 4)' % schema)
